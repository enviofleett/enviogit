...
CREATE POLICY "admin_owner_full_access_app_logs" 
ON public.app_logs 
FOR ALL 
TO authenticated
USING (
...
-- RLS policies for api_calls_monitor
CREATE POLICY "admin_owner_full_access_api_calls_monitor" 
...
-- RLS policies for edge_function_stats
CREATE POLICY "admin_owner_full_access_edge_function_stats" 
